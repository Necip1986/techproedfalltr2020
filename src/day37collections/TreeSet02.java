...
public class TreeSet02 {
	...
	public static void main(String[] args) {
		...
		TreeSet<String>ts1=new TreeSet<>(hs1); //parantez icine hashset ismi yazilirsa tree set'e cevrilmis olur.
		System.out.println(ts1);
		long endingTime1 = System.currentTimeMillis();
		System.out.println("Hash+Tree:"+(endingTime1-startingTime1));

		//hashSet+tree daha hizlidir treeSet'ten
